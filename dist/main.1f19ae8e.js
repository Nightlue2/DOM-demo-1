...
var codeArea = dom.pick("#showCode > span");
var codeWrapper = dom.pick("#showCode");
var storeString = "";
dom.text(codeArea, "");
...
function _access() {
  _access = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var show, square, round, i, clickFunc;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            show = dom.pick("#showContent");
            square = dom.create("<div id='square'>使用create创建的第一个元素</div>");
            _context.next = 4;
            return printCode("const show = dom.pick('#showContent')\n  const square = dom.create(\"\n  <div id='square'>\n    \u4F7F\u7528create\u521B\u5EFA\u7684\u7B2C\u4E00\u4E2A\u5143\u7D20\n  </div>\n  \")\n  dom.append(show,square)\n  ");

          case 4:
            dom.append(show, square);
            _context.next = 7;
            return printCode("dom.text(square)\n  ");

          case 7:
            alert("正方形的文本内容为：" + dom.text(square));
            _context.next = 10;
            return printCode("dom.text(square,'\u4FEE\u6539\u4E4B\u540E\u7B2C\u4E00\u4E2A\u5143\u7D20\u7684\u6587\u672C')\n  ");

          case 10:
            dom.text(square, "修改之后第一个元素的文本");
            _context.next = 13;
            return printCode("dom.attr(square,'id')\n  ");

          case 13:
            alert("正方形的id为：" + dom.attr(square, "id"));
            _context.next = 16;
            return printCode("dom.attr(square,'style','border:1px solid #81b9ff'); //\u628A\u6B63\u65B9\u5F62\u7684\u8FB9\u6846\u6539\u6210\u84DD\u8272\n  ");

          case 16:
            dom.attr(square, "style", "border:1px solid #81b9ff;");
            _context.next = 19;
            return printCode("const round = dom.create(\"<div id='round'></div>\")\n  dom.append(show,round)\n  ");

          case 19:
            round = dom.create("<div id='round'></div>");
            dom.append(show, round);
            _context.next = 23;
            return printCode("dom.before(round,square) //\u5706\u548C\u6B63\u65B9\u5F62\u8C03\u6362\u4F4D\u7F6E\n  ");

          case 23:
            dom.before(round, square);
            _context.next = 26;
            return printCode("dom.append(square,round) //\u628A\u5706\u653E\u5230\u6B63\u65B9\u5F62\u91CC\n  ");

          case 26:
            dom.append(square, round);
            _context.next = 29;
            return printCode('dom.append(show,dom.create("' + "\n" + "<span>" + "\n" + "即将被移除的第${i+1}个元素" + "\n" + "</span>" + '"))*3' + "\n");

          case 29:
            for (i = 0; i < 3; i++) {
              dom.append(show, dom.create("<span>\n    \u5373\u5C06\u88AB\u79FB\u9664\u7684\u7B2C".concat(i + 1, "\u4E2A\u5143\u7D20\n    </span>")));
            }

            _context.next = 32;
            return printCode("dom.each(dom.pickAll('span'),\n  item=>dom.style(item,'color','red')\n  )\n  ");

          case 32:
            dom.each(dom.pickAll("#showContent > span"), function (item) {
              return dom.style(item, "color", "red");
            });
            _context.next = 35;
            return printCode("dom.remove(dom.pick('span')) //\u5220\u9664\u4E00\u4E2Aspan\u6807\u7B7E\n  ");

          case 35:
            dom.remove(dom.pick("#showContent > span"));
            _context.next = 38;
            return printCode("const clickFunc = function(e){\n    window.alert('\u70B9\u51FB\u89E6\u53D1\u7684\u76EE\u6807\u7684id\u662F'+ e.target.id);\n  }\n  dom.on(round,'click',clickFunc);\n  ");
          ...
          case 38:
            ...
            _context.next = 43;
            return printCode("dom.parent(round)\n  ");

          case 43:
            dom.parent(round);
            _context.next = 46;
            return printCode("dom.children(square)\n");

          case 46:
            alert("正方形的孩子节点：" + dom.children(square)); //数组

            _context.next = 49;
            return printCode("dom.siblings(square)\n");

          case 49:
            alert("正方形的兄弟节点：" + dom.siblings(square)); //数组

            _context.next = 52;
            return printCode("dom.next(square)\n");

          case 52:
            alert("正方形的下一个兄弟节点：" + dom.next(square));
            _context.next = 55;
            return printCode("dom.index(dom.pick('span'))\n");

          case 55:
            alert("span元素是内容区里的第" + String(dom.index(dom.pick("#showContent > span")) + 1) + "位");
            _context.next = 58;
            return printCode("dom.empty(show) //6\u79D2\u540E\u6E05\u7A7A\u6240\u6709\u7528\u4E8E\u5C55\u793A\u7684\u8282\u70B9\n");
...
access();
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js"}],"../../../AppData/Local/Yarn/Data/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
